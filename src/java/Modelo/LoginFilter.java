...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        Usuario loginBean = (Usuario) req.getSession().getAttribute("usuario");
        ...
        if (loginBean != null && !loginBean.isAdministrador() && loginBean.getId() != 0) {
            if (!noProtegerNoAdmin(urlStr)) {
    ...
    private boolean noProtegerNoAdmin(String urlStr) {
         ...
         * compilación.
         */
        if (urlStr.endsWith("reservasusuario.xhtml")) {
            return true;
        }
        if (urlStr.endsWith("busquedaavanzada.xhtml")) {
            return true;
        }
        if (urlStr.endsWith("registrar.xhtml")) {
            return true;
        }
        if (urlStr.endsWith("principal.xhtml")) {
            return true;
        }
    ...
    private boolean noProteger(String urlStr) {
         ...
         * compilación.
         */
        if (urlStr.endsWith("error.xhtml")) {
            return true;
        }
        if (urlStr.endsWith("busquedaavanzada.xhtml")) {
            return true;
